...
To respond to these potential ethical concerns, we want to assure visitors to _Mapping the Gay Guides_ that the entirety of this data is derived from the Damron Address Books. We have taken few liberties (other than cleaning up incorrect or unclear addresses and organizing the types of locations) with the already existing data available to researchers.
