      ...
      <div class="col-lg-3">
        <div class="form-floating">
          ...
          <select class="form-control form-control" id="map-viewby-amenities">
            ...
            <option value="(B-1970-1989)">(B-1970-1989) - Blacks Frequent</option>
            <option value="(B-1990-1993)">(B-1990-1993) - Black Clientele or Multi-Racial Clientele</option>
            <option value="(B-1990-2005)">(B-1990-2005) - Bears</option>
            <option value="(BA)">(BA) - Bare-Ass (Usually nude beach)</option>
            <option value="(BYOB)">(BYOB) - Bring Your Own Bottle</option>
            <option value="(C-1965-1989)">(C-1965-1989) - Coffee, Soft Drinks, and Sometimes Snacks</option>
            <option value="(C-2003-2005)">(C-2003-2005) - Cabaret</option>
            ...
            <option value="(H-1965-1989)">(H) - Hotel, Motel, Resort, or other Overnight Accomodation</option>
            <option value="(H-1990-1995)">(H) - Hustlers</option>
            <option value="(HIP)">(HIP) - Heads Frequent</option>
            <option value="(L-1980-1989)">(L - 1980-1989) - Ladies</option>
            <option value="(L-1990-2005)">(L - 1990-2005) - Leather</option>
            <option value="(M-1965-1989)">(M - 1965-1989) - Mixed - Some Straights</option>
            <option value="(M-1996-2005)">(M - 1996-2005) - Mostly Men</option>
            <option value="(MCC)">(MCC) - Metropolitan Community Church</option>
            <option value="(N-1988-1989)">(N-1988-1989) - Neighborhood</option>
            <option value="(N-1990-2005)">(N-1990-2005) - Nudity</option>
            <option value="(OC)">(OC) - Older/More Mature Crowd</option>
            <option value="(P-1965-1989)">(P-1965-1989) - Private - Inquire Locally as to Admission</option>
            <option value="(P-1990-2002)">(P-1990-2002) - Professional Clientele</option>
            <option value="(P-2003-2005)">(P-2003-2005) - Piano Bar</option>
            <option value="(PE)">(PE) - Pretty Elegant - Often Coat or Tie</option>
            <option value="(PT)">(PT) - Pool Table</option>
            <option value="(R-1965-1989)">(R-1965-1989) - Restaurant</option>
            <option value="(R-2003-2005)">(R-2003-2005) - Reservations Required</option>
            <option value="(RT)">(RT) - Raunchy Types - Hustlers, Drags, and other 'Downtown Types'</option>
            <option value="(S-1965-2002)">(S-1965-2002) - Shows - Impersonators or Pantomime Acts - Often Touristy</option>
            <option value="(S-2003-2005)">(S-2003-2005) - Strippers and Go Go Dancers</option>
            <option value="(SM)">(SM) - Some Motorcycle & Leather</option>
            <option value="(W-1972-1989)">(W-1972-1989) - Western or Cowboy Types</option>
            <option value="(W-1990-2005)">(W-1990-2005) - Women</option>
