...
<figure>
<img src="/images/methodology-status-plot-revised-65-85.png" class="image-left" style="width:450px;">
<figcaption class="caption-left alert-secondary" style="width:450px;"><small><p><b>Figure 4.</b> Chart showing the breakdown between verified (22%), google verified (66%), and locations that could not be verified (12%).</p></small></figcaption>
</figure>
